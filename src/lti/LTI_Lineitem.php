...
class LTI_Lineitem {
    ...
    public function __construct(array $lineitem = null) {
        ...
        $this->start_date_time = array_key_exists("startDateTime", $lineitem) ? $lineitem["startDateTime"] : date(\DateTimeInterface::ISO8601);
        $this->end_date_time = array_key_exists("endDateTime", $lineitem) ? $lineitem["endDateTime"] : date(\DateTimeInterface::ISO8601);
    }
